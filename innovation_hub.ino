#define BLYNK_TEMPLATE_ID "TMPL3_fnsgSzN"
#define BLYNK_TEMPLATE_NAME "smart irraction system"
#define BLYNK_AUTH_TOKEN    "0aJLNDLNO5wSK60wjHR7lXED2NPVjL-H"
...
#define SOIL_PIN 5   // Analog pin (0–1V only on ESP8266!)
